...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="flex justify-between relative top-0 left-0 right-0 bg-white shadow-sm shadow-gray-300 max-h-full flex-col md:min-h-[80px] md:px-10 md:flex-row md:items-center">
